	...
	<div class="relative pb-15">
		...
		{#if sliderLoaded}
			...
			<button
				...
				class="absolute top-1/1 left-4/9 -translate-y-1/2 z-2 p-1 border-none bg-transparent focus:outline-none rounded-full invisible sm:visible"
			>
				<svg
			...
			<button
				...
				class="absolute top-1/1 left-5/9 -translate-y-1/2 z-2 p-1 border-none bg-transparent rounded-full invisible sm:visible"
			>
				<svg
					class="w-8 h-8 fill-gray-100 hover:fill-gray-300 hover:scale-120 active:scale-90 transition-all ease-in-out"
					xmlns="http://www.w3.org/2000/svg"
