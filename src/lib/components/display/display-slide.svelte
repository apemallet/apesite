...
>
  ...
  <div class="text-container px-10 sm:items-start flex flex-col gap-2 sm:gap-4">
    ...
    >
      <span class="text-black group-hover:text-white ease-in transition-all">
        Learn more
      </span>
    </a>
  </div>
  ...
  <img
    ...
    alt={product.name}
    class="w-auto h-auto object-contain rounded-4xl aspect-square"
  />
</div>
